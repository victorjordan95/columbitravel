// Requires jQuery
var convertValuesToTime = function(values,handle, leftValue, rightValue){
...
$(document).ready(function() {
  ...
  rangeSlider.noUiSlider.on('update', function(values, handle) {
    var leftValue = document.getElementById('slider-range-value1'),
    rightValue = document.getElementById('slider-range-value2');
    convertValuesToTime(values,handle, leftValue, rightValue);
  });
  rangeSlider2.noUiSlider.on('update', function(values, handle) {
    var leftValue = document.getElementById('volta1'),
    rightValue = document.getElementById('volta2');
    convertValuesToTime(values,handle, leftValue, rightValue);
  });

  rangeSlider3.noUiSlider.on('update', function(values, handle) {
    var leftValue = document.getElementById('duracao1'),
    rightValue = document.getElementById('duracao2');
    convertValuesToTime(values,handle, leftValue, rightValue);
  });
});
